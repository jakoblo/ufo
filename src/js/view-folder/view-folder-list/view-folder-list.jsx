...
export default // @DropTarget(NativeTypes.FILE, FolderDropTarget, (connect, monitor) => ({
...
class DisplayList extends React.Component {
      ...
      <AutoSizer>
        {({ width, height }) => (
          <List
            ...
            scrollToIndex={
              this.props.selected
                ? this.props.fileList.indexOf(this.props.selected.last())
                : undefined
            }
            tabIndex={-1}
  ...
  handleExpandSelection = (base, file) => {
    if (this.props.selected.size > 0) {
      ...
      this.props.dispatch(
        Selection.actions.filesAdd([nodePath.join(this.props.path, base)])
      );
    }
  };
